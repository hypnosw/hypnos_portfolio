      ...
      <nav className={"hw-navbar-wrapper"}>
        ...
        <div className={"d-none d-sm-none d-md-flex hw-navbar "
          ...
          <ol className={"col-auto my-1 d-flex justify-content-around "
                         + "list-unstyled"}>
            <li className={"mx-3"}>
              <Link to={"/about"} className={"hw-nav-link Roboto-Regular-400"}>
                About
              </Link>
            </li>
            <li className={"mx-3"}>
          ...
          <div className={"col-2 my-1 d-flex justify-content-end"}>
            <div className={"d-flex justify-content-between"}>
              <a className={"me-3 hw-navicon"} href={"https://github.com/hypnosw"} target={"_blank"}>
                <FaGithub />
              </a>
              <a className={"me-3 hw-navicon"} href={"https://www.linkedin.com/in/hypnosw/"} target={"_blank"}>
                <FaLinkedin />
              </a>
            </div>
